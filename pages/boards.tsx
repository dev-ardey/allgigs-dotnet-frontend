...
}> = ({ company, onClick, isSelected, onSelectionChange, sourceJobStats, getIndustryColor }) => {
            ...
            <div className="calculator-section">
                <div className="calculator-split-container">
                    ...
                    <div className="calculator-right">
                        ...
                        <div className="industry-stats-section" style={{ marginBottom: '20px', padding: '16px', background: '#f9fafb', borderRadius: '8px' }}>
