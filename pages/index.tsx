    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '1.25rem', fontWeight: 600, color: 'white' }}>Loading jobs...</div>
          <div style={{ color: '#0ccf83', marginTop: '0.5rem' }}>Please wait while we fetch the latest opportunities</div>
        </div>
      </div>
    )
